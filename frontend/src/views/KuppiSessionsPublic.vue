...
<template>
  <div class="min-h-screen bg-[#F4F7F9] font-sans pt-[90px] pb-16">
    
    <!-- Hero Banner -->
    <div class="relative bg-gradient-to-br from-[#2C3E50] to-[#1a252f] text-white py-16 px-4 mb-10 overflow-hidden">
      <div class="absolute -right-20 -top-20 w-80 h-80 bg-[#4A90E2]/20 blur-3xl rounded-full"></div>
      <div class="absolute -left-10 -bottom-10 w-60 h-60 bg-[#A8E6CF]/15 blur-3xl rounded-full"></div>
      
      <div class="max-w-[1200px] mx-auto relative z-10">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div class="flex items-center gap-2 mb-4">
              <span class="bg-white/10 backdrop-blur-md border border-white/20 text-white text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">Peer Tutoring</span>
            </div>
            <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight mb-3">
              Kuppi <span class="text-[#4A90E2]">Sessions</span> 💡
            </h1>
            <p class="text-slate-300 text-lg max-w-[500px] leading-relaxed">
              Learn from your peers! Join live student-led tutoring sessions, discuss past papers, and ace your exams together.
            </p>
          </div>
          
          <div class="flex flex-col items-end gap-2 text-right">
            <div class="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5 text-center">
    ...
    <div class="max-w-[1200px] mx-auto px-4">
      ...
      <!-- CTA Banner -->
      <div class="mt-12 bg-gradient-to-r from-[#2C3E50] to-[#34495e] rounded-[20px] p-8 flex flex-col md:flex-row items-center justify-between gap-6 border border-slate-700/50 relative overflow-hidden">
